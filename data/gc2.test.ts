// GC2 Test Drills Data - Gracie Combatives Proficiency Drills (GCPDs)
import type { TestDrill } from '@/app/types/test-drill.types';

export const gc2TestDrills: TestDrill[] = [
...
// Export helper function to get test drills for GC2
export const getGC2TestDrills = (): TestDrill[] => {
  return gc2TestDrills;
};
